...
export class DetailPage implements OnInit {
  ...
  async getUserLeavesDetail(id: any){
    ...
    let resp = await this.service.dinasDetail(id);

    resp.subscribe((res: any) => {
      loading.dismiss();
      console.log(res);
      this.userDinasDetail = res.data
      // this.userDinasDetail.request_date = this.parseTanggal(this.userDinasDetail.request_date);
      // if(this.userDinasDetail.approved_date){
      //   this.userDinasDetail.approved_date = this.parseTanggal(this.userDinasDetail.approved_date);
      // }
    })
  }
